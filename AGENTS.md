...
This project is indexed by GitNexus as **franc-system-template** (239 symbols, 231 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
